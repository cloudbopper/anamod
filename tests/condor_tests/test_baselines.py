...
def test_condor_simulation_baseline_time(data_regression, tmpdir, caplog, shared_fs):
...
def test_condor_simulation_baseline_time_all(data_regression, tmpdir, caplog, shared_fs):
